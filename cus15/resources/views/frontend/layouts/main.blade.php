...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/css/stylesheet22.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/css/cart.css') }}">

    @yield('css')
	<!-- google anlytic-->
    @if(isset($header['google-anlytic']->description) && $header['google-anlytic']->description)
        {{$header['google-anlytic']->description}}
    @endif

	<!-- code top-->
    @if(isset($header['code-top']->description) && $header['code-top']->description)
        {{$header['code-top']->description}}
    @endif
...
<body class="template-search">
	<!-- code home-->
    @if(isset($header['code-home']->description) && $header['code-home']->description)
        {{$header['code-home']->description}}
    @endif
    ...
    @yield('js')
    <!-- code bottom-->
    @if(isset($header['code-bottom']->description) && $header['code-bottom']->description)
        {{$header['code-bottom']->description}}
    @endif
