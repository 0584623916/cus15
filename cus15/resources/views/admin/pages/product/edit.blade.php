                                            ...
                                            <div id="tong_quan" class="container tab-pane active"><br>
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div id="tong_quan_{{$langItem['value']}}" class="container wrapChangeSlug tab-pane {{$langItem['value']==$langDefault?'active show':''}} fade">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <label class="col-sm-2 control-label" for="">Quy mô</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control
                                                                    @error('text1_'.$langItem['value']) is-invalid @enderror" id="text1_{{$langItem['value']}}" value="{{ old('text1_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->text1 }}" name="text1_{{$langItem['value']}}" placeholder="Nhập quy mô">
                                                                    @error('text1_'.$langItem['value'])
                                                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                                                    @enderror
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <label class="col-sm-2 control-label" for="">Tổng mức đầu tư</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control
                                                                    @error('text2_'.$langItem['value']) is-invalid @enderror" id="text2_{{$langItem['value']}}" value="{{ old('text2_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->text2 }}" name="text2_{{$langItem['value']}}" placeholder="Nhập tổng mức đầu tư">
                                                                    @error('text2_'.$langItem['value'])
                                                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                                                    @enderror
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control
                                                                    @error('text3_'.$langItem['value']) is-invalid @enderror" id="text3_{{$langItem['value']}}" value="{{ old('text3_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->text3 }}" name="text3_{{$langItem['value']}}" placeholder="Nhập địa chỉ">
                                                                    @error('text3_'.$langItem['value'])
                                                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                                                    @enderror
                                                                </div>
                                                            </div>
