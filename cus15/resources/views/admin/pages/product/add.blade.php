                                                    ...
                                                    <div id="tong_quan_{{$langItem['value']}}" class="container wrapChangeSlug tab-pane {{$langItem['value']==$langDefault?'active show':''}} fade">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control
                                                                    @error('text1_'.$langItem['value']) is-invalid @enderror" id="text1_{{$langItem['value']}}" value="{{ old('text1_'.$langItem['value']) }}" name="text1_{{$langItem['value']}}" placeholder="Nhập quy mô">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control
                                                                    @error('text2_'.$langItem['value']) is-invalid @enderror" id="text2_{{$langItem['value']}}" value="{{ old('text2_'.$langItem['value']) }}" name="text2_{{$langItem['value']}}" placeholder="Nhập tổng mức đầu tư">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control
                                                                    @error('text3_'.$langItem['value']) is-invalid @enderror" id="text3_{{$langItem['value']}}" value="{{ old('text3_'.$langItem['value']) }}" name="text3_{{$langItem['value']}}" placeholder="Nhập địa chỉ">
