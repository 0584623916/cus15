...
@section('title', 'Sửa danh mục ' . $categoryConfig['type'])
@section('css')
...
@section('content')
    ...
    <div class="content-wrapper lb_template_categoryproduct_edit">
        @include('admin.partials.content-header',['name'=>"Danh mục","key"=>"Sửa danh mục ".$categoryConfig['type']])
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal"
                            action="{{ route($categoryConfig['routeNameUpdate'], ['id' => $data->id]) }}" method="POST"
                                                ...
                                                <div class="form-check-inline">
                                                    <label class="form-check-label">
                                                        <input type="radio" class="form-check-input" value="1" name="active"
                                                            @if ((old('active') ?? $data->active) == '1') {{ 'checked' }} @endif>
                                                        Hiện
                                                    </label>
                                                </div>
                                                <div class="form-check-inline">
                                                    <label class="form-check-label">
                                                        <input type="radio" class="form-check-input" value="0"
                                                            @if ((old('active') ?? $data->active) == '0'){{ 'checked' }} @endif name="active">
                                                        Ẩn
                                                    </label>
                                                </div>
                                                @error('active')
